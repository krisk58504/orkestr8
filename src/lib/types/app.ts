...
export type AutomationMode = Enums<"automation_mode_type">;
...
export type RentChargeType = Enums<"rent_charge_type">;
export type RentChargeStatus = Enums<"rent_charge_status">;
